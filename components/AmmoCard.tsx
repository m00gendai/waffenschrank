...
export default function AmmoCard({ammo, stockVisible, setStockVisible}:Props){
    ...
    const { ammoDbImport, displayAmmoAsGrid, setDisplayAmmoAsGrid, toggleDisplayAmmoAsGrid, sortAmmoBy, setSortAmmoBy, language, theme, listImages } = usePreferenceStore()
    ...
    return(
        ...
        >
            <Card.Title
                titleStyle={{
                width: displayAmmoAsGrid ? "100%" : listImages ? "60%" : "80%",
