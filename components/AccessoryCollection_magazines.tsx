...
export default function AccessoryCollection_optics({navigation, route}){
  ...
  const { displayAsGrid, toggleDisplayAsGrid, sortBy, setSortBy, language, setSortGunIcon, sortGunIcon, sortGunsAscending, toggleSortGunsAscending, theme, magazinesFilterOn } = usePreferenceStore()
