...
export default function EditGun({setEditGunOpen, gun, setCurrentGun}){

    const [selectedImage, setSelectedImage] = useState(gun.images && gun.images.length != 0 ? gun.images : null)
    ...
    async function save(key, value) {
        ...
        const index = editedResult.findIndex(item =>{
            if(value.id === item.id){
                return true
            }
            return false
         })
        editedResult.splice(index, 1, {...value, images:selectedImage})
    ...
    return(
        <View style={{width: "100%", height: "100%"}}>
            ...
            <Appbar.Header style={{width: "100%"}}>
                ...
                <Appbar.Action icon="floppy" onPress={() => save(GUN_DATABASE, gunData)} />
            </Appbar.Header>
